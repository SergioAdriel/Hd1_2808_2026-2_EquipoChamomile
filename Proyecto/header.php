  ...
  <nav class="red darken-2" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a href="../Controlador/registroVista.php" class="white-text" style="font-weight: bold;">Registro</a></li>
        <?php endif; ?>

        <?php if (!isset($_SESSION['trainer_id'])): ?>
        <li><a href="../Controlador/login.php" class="white-text" style="font-weight: bold;">Iniciar sesión</a></li>
        <?php endif; ?>
      ...
      <ul id="nav-mobile" class="sidenav">
        <?php if (!isset($_SESSION['trainer_id'])): ?>
        <li><a href="../Controlador/registroVista.php">Registro</a></li>
        <?php endif; ?>
